 ...
 *
 * @export
 * @interface NetworksNetworkTokensAddressGet200Response
 */
export interface NetworksNetworkTokensAddressGet200Response {
  /**
   *
   * @type {Token}
   * @memberof NetworksNetworkTokensAddressGet200Response
   */
  data?: Token
}

/**
 * Check if a given object implements the NetworksNetworkTokensAddressGet200Response interface.
 */
export function instanceOfNetworksNetworkTokensAddressGet200Response(
  value: object
): value is NetworksNetworkTokensAddressGet200Response {
  return true
}

export function NetworksNetworkTokensAddressGet200ResponseFromJSON(
  json: any
): NetworksNetworkTokensAddressGet200Response {
  return NetworksNetworkTokensAddressGet200ResponseFromJSONTyped(json, false)
}

export function NetworksNetworkTokensAddressGet200ResponseFromJSONTyped(
  json: any,
...
export function NetworksNetworkTokensAddressGet200ResponseToJSON(
  value?: NetworksNetworkTokensAddressGet200Response | null
): any {
  if (value == null) {
    return value
  }
