 ...
 */
export function instanceOfOhlcvDataAttributes(
  value: object
): value is OhlcvDataAttributes {
  return true
}
...
export function OhlcvDataAttributesFromJSONTyped(
  json: any,
...
export function OhlcvDataAttributesToJSON(
  value?: OhlcvDataAttributes | null
): any {
  if (value == null) {
    return value
  }
