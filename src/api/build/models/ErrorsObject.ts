...
import type { ErrorsObjectErrorsInner } from './ErrorsObjectErrorsInner'
import {
  ErrorsObjectErrorsInnerFromJSON,
  ErrorsObjectErrorsInnerFromJSONTyped,
  ErrorsObjectErrorsInnerToJSON,
} from './ErrorsObjectErrorsInner'
...
export interface ErrorsObject {
  /**
   *
   * @type {Array<ErrorsObjectErrorsInner>}
   * @memberof ErrorsObject
   */
  errors?: Array<ErrorsObjectErrorsInner>
}

/**
 * Check if a given object implements the ErrorsObject interface.
 */
export function instanceOfErrorsObject(value: object): value is ErrorsObject {
  return true
}
...
export function ErrorsObjectFromJSONTyped(
  json: any,
  ...
  return {
    errors:
      json['errors'] == null
        ? undefined
        : (json['errors'] as Array<any>).map(ErrorsObjectErrorsInnerFromJSON),
  }
}
...
export function ErrorsObjectToJSON(value?: ErrorsObject | null): any {
  ...
  return {
    errors:
      value['errors'] == null
        ? undefined
        : (value['errors'] as Array<any>).map(ErrorsObjectErrorsInnerToJSON),
  }
}
