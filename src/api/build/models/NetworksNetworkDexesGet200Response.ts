...
import type { NetworksNetworkDexesGet200ResponseDataInner } from './NetworksNetworkDexesGet200ResponseDataInner'
import {
  NetworksNetworkDexesGet200ResponseDataInnerFromJSON,
  NetworksNetworkDexesGet200ResponseDataInnerFromJSONTyped,
  NetworksNetworkDexesGet200ResponseDataInnerToJSON,
} from './NetworksNetworkDexesGet200ResponseDataInner'

/**
 *
 * @export
 * @interface NetworksNetworkDexesGet200Response
 */
export interface NetworksNetworkDexesGet200Response {
  /**
   *
   * @type {Array<NetworksNetworkDexesGet200ResponseDataInner>}
   * @memberof NetworksNetworkDexesGet200Response
   */
  data?: Array<NetworksNetworkDexesGet200ResponseDataInner>
}

/**
 * Check if a given object implements the NetworksNetworkDexesGet200Response interface.
 */
export function instanceOfNetworksNetworkDexesGet200Response(
  value: object
): value is NetworksNetworkDexesGet200Response {
  return true
}

export function NetworksNetworkDexesGet200ResponseFromJSON(
  json: any
): NetworksNetworkDexesGet200Response {
  return NetworksNetworkDexesGet200ResponseFromJSONTyped(json, false)
}

export function NetworksNetworkDexesGet200ResponseFromJSONTyped(
  json: any,
...
export function NetworksNetworkDexesGet200ResponseToJSON(
  value?: NetworksNetworkDexesGet200Response | null
): any {
  if (value == null) {
    return value
  }
