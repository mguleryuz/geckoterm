...
import { TokenFromJSON, TokenFromJSONTyped, TokenToJSON } from './Token'

/**
 *
 * @export
 * @interface NetworksNetworkTokensMultiAddressesGet200Response
 */
export interface NetworksNetworkTokensMultiAddressesGet200Response {
  /**
   *
   * @type {Array<Token>}
   * @memberof NetworksNetworkTokensMultiAddressesGet200Response
   */
  data?: Array<Token>
  /**
   *
...
/**
 * Check if a given object implements the NetworksNetworkTokensMultiAddressesGet200Response interface.
 */
export function instanceOfNetworksNetworkTokensMultiAddressesGet200Response(
  value: object
): value is NetworksNetworkTokensMultiAddressesGet200Response {
  return true
}

export function NetworksNetworkTokensMultiAddressesGet200ResponseFromJSON(
  json: any
): NetworksNetworkTokensMultiAddressesGet200Response {
  return NetworksNetworkTokensMultiAddressesGet200ResponseFromJSONTyped(
    json,
    false
  )
}

export function NetworksNetworkTokensMultiAddressesGet200ResponseFromJSONTyped(
  json: any,
  ...
  return {
    data:
      json['data'] == null
        ? undefined
        : (json['data'] as Array<any>).map(TokenFromJSON),
    included: json['included'] == null ? undefined : json['included'],
  }
}

export function NetworksNetworkTokensMultiAddressesGet200ResponseToJSON(
  value?: NetworksNetworkTokensMultiAddressesGet200Response | null
): any {
  if (value == null) {
    return value
  }
  return {
    data:
      value['data'] == null
        ? undefined
        : (value['data'] as Array<any>).map(TokenToJSON),
