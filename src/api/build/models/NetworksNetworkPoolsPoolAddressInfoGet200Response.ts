 ...
 *
 * @export
 * @interface NetworksNetworkPoolsPoolAddressInfoGet200Response
 */
export interface NetworksNetworkPoolsPoolAddressInfoGet200Response {
  /**
   *
   * @type {Array<TokenInfo>}
   * @memberof NetworksNetworkPoolsPoolAddressInfoGet200Response
   */
  data?: Array<TokenInfo>
}

/**
 * Check if a given object implements the NetworksNetworkPoolsPoolAddressInfoGet200Response interface.
 */
export function instanceOfNetworksNetworkPoolsPoolAddressInfoGet200Response(
  value: object
): value is NetworksNetworkPoolsPoolAddressInfoGet200Response {
  return true
}

export function NetworksNetworkPoolsPoolAddressInfoGet200ResponseFromJSON(
  json: any
): NetworksNetworkPoolsPoolAddressInfoGet200Response {
  return NetworksNetworkPoolsPoolAddressInfoGet200ResponseFromJSONTyped(
    json,
    false
  )
}

export function NetworksNetworkPoolsPoolAddressInfoGet200ResponseFromJSONTyped(
  json: any,
  ...
  return {
    data:
      json['data'] == null
        ? undefined
        : (json['data'] as Array<any>).map(TokenInfoFromJSON),
  }
}

export function NetworksNetworkPoolsPoolAddressInfoGet200ResponseToJSON(
  value?: NetworksNetworkPoolsPoolAddressInfoGet200Response | null
): any {
  if (value == null) {
    return value
  }
  return {
    data:
      value['data'] == null
        ? undefined
        : (value['data'] as Array<any>).map(TokenInfoToJSON),
  }
}
